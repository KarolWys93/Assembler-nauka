/*
 * Projekt pokazowy 2
 * Przycisk distabilny + prze³¹czanie kolorów
 *
...
WAIT_20_MS:
	PUSH XH	;wrzucamy na stos rejestry które chcemy zachowaæ
	IN XH, SREG
	PUSH XH
	PUSH XL

	LDI XH, HIGH(F_CPU*0.02/4)	;wyliczamy wartoœci liczników ze wzoru
	LDI XL, LOW(F_CPU*0.02/4)
	
	DELAY_LOOP:	;zmniejszanie wartoœci licznika w pêtli a¿ dojdzie do 0
	SBIW XL, 1
	BRNE DELAY_LOOP


	POP XL	; przywracamy wartoœci rejestrów
	POP XH
	OUT SREG, XH
	POP XH
	RET	;powrót
